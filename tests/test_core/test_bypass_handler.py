...
from djangoapi_guard.core.bypass.context import BypassContext
from djangoapi_guard.core.bypass.handler import BypassHandler
...
def mock_response_factory() -> Mock:
    ...
    factory = Mock()
    factory.apply_modifier = MagicMock(return_value=HttpResponse("OK", status=200))
    return factory
