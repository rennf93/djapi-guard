...
class SecurityConfig(BaseModel):
    ...
    custom_request_check: Callable[[HttpRequest], HttpResponse | None] | None = Field(
    ...
    custom_response_modifier: Callable[[HttpResponse], HttpResponse] | None = Field(
        default=None,
    ...
    enable_agent: bool = Field(
        default=False, description="Enable API Guard Agent telemetry and monitoring"
    )
    """
    bool:
        Whether to enable the API Guard Agent for telemetry,
