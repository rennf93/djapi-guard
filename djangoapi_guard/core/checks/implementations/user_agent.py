...
class UserAgentCheck(SecurityCheck):
    ...
    def _log_blocked_user_agent(self, request: HttpRequest, user_agent: str) -> None:
    ...
    def _send_route_violation_event(
        self, request: HttpRequest, user_agent: str
    ) -> None:
    ...
    def _send_global_block_event(self, request: HttpRequest, user_agent: str) -> None:
    ...
    def _send_block_event(
        self, request: HttpRequest, user_agent: str, route_config: Any
    ) -> None:
