...
_logger = logging.getLogger("djangoapi_guard.detection_engine.monitor")
...
class PerformanceMonitor:
    ...
    def _send_anomaly_event(
        ...
        try:
            ...
            _logger.debug("Failed to send anomaly event", exc_info=True)
    ...
    def _send_callback_error_event(
        ...
        try:
            ...
            _logger.debug("Failed to send callback error event", exc_info=True)
