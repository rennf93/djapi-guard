...
# Django specific - these are used by Django's middleware/routing
# and may appear unused to static analysis
process_request  # type: ignore  # pragma: no cover
process_response  # type: ignore  # pragma: no cover
process_view  # type: ignore  # pragma: no cover
process_exception  # type: ignore  # pragma: no cover
get_response  # type: ignore  # pragma: no cover
